label breakfast:
    ...
    nvl_narrator "After I met Amélie –{w} no, when we woke up together at the sound of a common alarm, hugging each other in the same bed –{w} it became easier.{w}
    ...
    nvl_narrator """
      The moment she heard me, she perked up. Her head darted towards me in a swift motion, and she was all smiles,{w} not unlike a lamb who has just seen her mother and runs towards her, elated to see her again, and nuzzles against her wool.

      There was such a stark contrast between how she was when she focused on brewing hot cocoa for us –{w} lost, relaxed, distant, or perhaps dreaming, stirring the pot without a thought for it ;{w} her movements were automatic –{w} and her attitude when she saw me.

    She hasn’t lost that joy.{w} Today still, she loves me and loves being with me.
    """
    ...
    nvl_narrator """
      I think her enthusiasm is the reason I fell for her. I certainly felt like I loved her more and more, day after day, as I kissed her,{w}
      loved her,{w} and she kissed me in return,{w} assuring me all the while that she felt ever so lucky to be with me.
    ...
    "I lost myself within the whirl, enjoying every smell:{w} the warmth of the chocolate,{w} 
    the faintest dash of vanilla."
    "Milk too;{w} but that was an aroma less pleasant, and it soon faded away to become cocoa."
    ...
    nvl_narrator "There was something astounding in her haste,{w} and I would wonder time and time again if she could taste anything through the heat."

    nvl clear

    nvl_narrator "As for the pain, Amélie had proved time and time again her ability to withstand it:{w} be as it may,
    I had long since accepted that she and I had nothing in common on that front,{w} and that something that would make me cry in agony, she would welcome quite happily."
    nvl_narrator "Why, most of the time, she even moaned."

    nvl clear

    nvl_narrator "There was still some time left before the laundry cycle would be done, and more time still before I would have to leave for work, so we settled on the sofa and started watching some videos on YouTube together."
    nvl_narrator "That day, it was something about bunkers and how they work;{w} more of an analysis of the use of the theme in science-fiction and some experiments than a practical dive into their engineering."

    nvl clear

    nvl_narrator "Various musings on how life must feel for those trapped in a shelter, with no hope of ever seeing the outside world;{w} to be stuck with the same people all your life,{w} to breathe the same recycled air,{w} and to spend your time repairing the same systems that keep you alive;{w} becoming so attached to the society people once had during better times that you do everything in your power to keep it in place, with no room for growth."
    nvl_narrator "It felt melancholy."
    
    nvl clear

    nvl_narrator """
      Still,{w} I was happy.{w} I was next to the one I loved and we were watching a video together.{w} My mug was warm, and the cocoa was sweet on my tongue;{w} it had been mixed unevenly, and big chunks of chocolate were stuck at the bottom,{w} almost overpowering in their taste compared to the milk I had drunk before.

      It was full of love, and the best I had ever had.
    """
    ...
    nvl_narrator "Despite it, she nuzzled my shoulder with her head,{w} and that sign of affection was enough to douse the worry at the back of my mind,{w} and we were once more a loving pair.{w} Amélie chided me for not having waited for her, and she rewound the video back."
    nvl_narrator "It was clear that she no longer thought about the wounds on her arm, for she didn’t make any comment, and neither did she marvel at \“how pretty they were\”.{w} My own reasons pushed me to ignore them and to not look at the cuts and bruises glistening beneath the gel."
    nvl_narrator "I much preferred to leave all those marks behind, lock them behind the bedroom door and pay them no heed once we were done. In a way, her nonchalant attitude helped me achieve that."
    ...
    nvl_narrator "She quickly sat up from her chair and took off her pajamas in front of me, leaving them on her desk."
    nvl_narrator "She was beautiful."
    nvl_narrator "In this moment,{w} I desired nothing more than to grab her and push her against the wall,{w} to put my hand on her chest,{w} on her butt,{w} on her hips{w} and grope every part of her being:{w} to let her know how much I loved her,{w} how much I lusted for her;{w} to hear her moan my name,{w} thank me for the attention,{w} thank me for using her."
    nvl_narrator "I would make her mine.{w} She loved when I told her she was mine."
    nvl clear
    nvl hide dissolve
    ...
    "So I… I hugged her close to me.{w} My arm brushed against her back, right against the scar."
    "She made a small cry, right between pain and surprise.{w} I sensed her tense against me for an instant, and then she laughed."
    sub "I should probably put on a bandage, and disinfect it again.{w} A shame."
    dom "Yeah. That’s a good idea"

    "How could she not hear the emptiness in my voice?{w} The distance?"
    "Probably because I made it impossible for her to."
    "I helped her with the wound.{w} Carefully disinfecting it again, just like I did last night.{w} Again, she winced.{w} Again, she laughed.{w} Something about her nerves, about that type of pain."
    sub "Thanks, babe."
    dom "Amélie?"
    sub "Yeah?"
    dom "I love you too."
